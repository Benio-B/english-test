const allQuestions = [
  ...
  {
    english:
      "To be cheesy (The movie was so cheesy, I couldn't take it seriously)",
    french:
      "Être ringard (Le film était tellement ringard que je ne pouvais pas le prendre au sérieux)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
    ...
    french:
      "Débourser (J'ai dû débourser beaucoup d'argent pour les réparations de la voiture)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
  ...
  },
  {
    ...
    french:
      "De mauvaise qualité (Le produit qu'ils m'ont vendu était de mauvaise qualité)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
  ...
  {
    english:
      "Can I give you my two cents' worth? (Can I give you my two cents' worth on this issue?)",
    french:
      "Puis-je te donner mon avis ? (Puis-je te donner mon avis sur ce sujet ?)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
  ...
  {
    english:
      "Basket case (After working so much, he became a real basket case)",
    french:
      "Un cas désespéré (Après avoir tant travaillé, il est devenu un vrai cas désespéré)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
    english:
      "Back in the day (Back in the day, we used to play outside all day)",
  ...
  {
    english:
      "To hit the road (We need to hit the road if we want to arrive on time)",
    french:
      "Prendre la route (Nous devons prendre la route si nous voulons arriver à l'heure)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
  ...
  {
    english:
      "To be in the doghouse (He's in the doghouse after forgetting their anniversary)",
    french:
      "Être dans le pétrin (Il est dans le pétrin après avoir oublié leur anniversaire)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
  ...
  },
  {
    ...
    french:
      "Une grosse galère (Déménager dans une nouvelle maison est une grosse galère)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
  ...
  {
    english:
      "To go ballistic (He went ballistic when he found out his car was stolen)",
    french:
      "Piquer une crise/péter les plombs (Il a piqué une crise quand il a découvert que sa voiture avait été volée)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
  ...
  },
  {
    ...
    french:
      "Quelque chose de très simple (Choisir la bonne réponse était très simple)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
    ...
    french:
      "Avoir plus d'un tour dans sa manche (Il a toujours quelques tours dans sa manche)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
    english:
      "Scalper (The scalper was selling concert tickets for double the price)",
    french:
      "Revendeur (Le revendeur vendait des billets de concert pour le double du prix)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
    ...
    french:
      "Se faire arnaquer (Il s'est fait arnaquer quand il a acheté cette montre)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
    english:
      "The whole nine yards (They went the whole nine yards to make sure the event was a success)",
    french:
      "Tout le nécessaire/la totale (Ils ont fait tout le nécessaire pour s'assurer que l'événement soit un succès)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
    english:
      "To be a day late and a dollar short (He tried to fix the problem, but it was a day late and a dollar short)",
    french:
      "Arriver après la bataille/trop tard/en retard (Il a essayé de résoudre le problème, mais il est arrivé après la bataille)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
    english:
      "Cut yourself some slack (You should cut yourself some slack! We can all fail)",
    french:
      "Ne pas être si dur avec toi (Tu ne devrais pas être si dur avec toi-même. On peut tous échouer)",
    category: "expression",
    explicitCategory: "Expressions/Phrases types",
  },
  {
  ...
  {
    english:
      "Binoculars (He used binoculars to watch the birds in the distance)",
    french:
      "Jumelles (Il a utilisé des jumelles pour observer les oiseaux au loin)",
    category: "vocabulary",
    explicitCategory: "Vocabulaire de tous les jours",
  },
  {
  ...
  },
  {
    ...
    french:
      "Vignoble (Ils ont visité un vignoble lors de leur voyage dans la Napa Valley)",
    category: "car",
  ...
  {
    english:
      "Hiccup (USA) / Hiccough (UK) (He had a hiccup after drinking soda)",
